...
class SleepTrackerViewModel(val database: SleepDatabaseDao,
     ...
     */
    private var viewModelJob = Job() //a background job
    ...
    /**
     * Converted Live<nights> to Live<Spanned> for displaying.
     */
    val nightsString: LiveData<Spanned> = Transformations.map(nights) { nights: List<SleepNight> ->
